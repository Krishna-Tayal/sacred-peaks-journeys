  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium font-body ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gold: "bg-gradient-gold text-primary font-semibold shadow-gold hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]",
        hero: "bg-gradient-gold text-primary font-semibold text-base shadow-gold hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] rounded-full",
        "outline-gold": "border-2 border-gold text-gold hover:bg-gold hover:text-primary font-semibold rounded-full",
      },
      size: {
